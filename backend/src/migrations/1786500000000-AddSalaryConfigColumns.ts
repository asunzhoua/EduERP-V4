...
export class AddSalaryConfigColumns1786500000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN lessonId bigint NULL;`,
    );
    // ruleVersion 修复：varchar(20) → varchar(50)，存 YYYY-MM-DD
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN ruleVersion varchar(50) NOT NULL;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN lessonDate date NULL;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN duration int NULL;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record ADD COLUMN source varchar(20) NOT NULL DEFAULT 'LESSON_FEE' AFTER salaryRuleId;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record ADD COLUMN month char(7) NULL AFTER source;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record ADD COLUMN studentCount int NULL AFTER duration;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record ADD COLUMN detail json NULL AFTER studentCount;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record ADD COLUMN needsReview tinyint NOT NULL DEFAULT 0 AFTER detail;`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE salary_record DROP COLUMN needsReview;`,
    );
    await queryRunner.query(`ALTER TABLE salary_record DROP COLUMN detail;`);
    await queryRunner.query(
      `ALTER TABLE salary_record DROP COLUMN studentCount;`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN duration int NOT NULL;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN lessonDate date NOT NULL;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN ruleVersion varchar(20) NOT NULL;`,
    );
    await queryRunner.query(
      `ALTER TABLE salary_record MODIFY COLUMN lessonId bigint NOT NULL;`,
    );
    await queryRunner.query(
