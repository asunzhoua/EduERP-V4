...
export class TeacherController {
  ...
  async getMyCourses(@CurrentUser() user: any) {
    const courseCodes = await this.dataScopeService.getTeacherCourseCodes(user.sub);
  ...
  async getMyClasses(@CurrentUser() user: any) {
    const classCodes = await this.dataScopeService.getTeacherClassCodes(user.sub);
  ...
  async getMyStudents(@CurrentUser() user: any) {
    const studentCodes = await this.dataScopeService.getTeacherStudentCodes(user.sub);
