...
Page({
  ...
  goToChildDetail(e) {
    ...
    // 将基本信息通过 URL 参数传递
    wx.navigateTo({
      url: `/pages/parent/child-detail?id=${id}&name=${encodeURIComponent(name || '')}&studentCode=${encodeURIComponent(studentcode || '')}&school=${encodeURIComponent(school || '')}&grade=${encodeURIComponent(grade || '')}`,
      fail() {
